          ...
          <div className="grid lg:grid-cols-3 gap-12 items-center">
            <div className="lg:col-span-2">
              ...
              <div className="flex flex-wrap gap-4">
                <a href="https://github.com/andrewgotora/sap-btp-ai-hub" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-blue-500 text-white font-bold rounded-xl hover:bg-blue-400 transition-all hover:scale-105">
                  <Github className="w-5 h-5" /> Source Code
                </a>
                <a href="https://andrewgotora.github.io/sap-btp-ai-hub/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 border-2 border-blue-500 text-blue-400 font-bold rounded-xl hover:bg-blue-500/10 transition-all hover:scale-105">
